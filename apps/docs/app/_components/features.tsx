const features = [
  {
    icon: '🛡️',
    title: 'Type Safe',
    description: 'Complete TypeScript inference from input to output, with end-to-end type safety and IDE hints out of the box',
    color: 'bg-neon-purple/15 shadow-[0_0_20px_rgba(139,92,246,0.15)]',
  },
  {
    icon: '⚡',
    title: 'Lightweight',
    description: 'Zero external dependencies, independently usable functions, and a tiny bundle footprint that keeps projects fast',
    color: 'bg-neon-blue/15 shadow-[0_0_20px_rgba(59,130,246,0.15)]',
  },
  {
    icon: '🌲',
    title: 'Tree-shakable',
    description: 'ESM-only by design, so build tools can remove unused code and ship only what you actually need',
    color: 'bg-neon-cyan/15 shadow-[0_0_20px_rgba(34,211,238,0.15)]',
  },
  {
    icon: '🧩',
    title: 'Modular Design',
    description: 'Array, Object, String, Guard, and Types utilities are grouped by domain and ready to import on demand',
    color: 'bg-pink-500/15 shadow-[0_0_20px_rgba(236,72,153,0.15)]',
  },
  {
    icon: '✅',
    title: 'Fully Tested',
    description: 'Every function is covered by focused unit tests, keeping behavior predictable and reliable',
    color: 'bg-emerald-400/15 shadow-[0_0_20px_rgba(52,211,153,0.15)]',
  },
  {
    icon: '📖',
    title: 'Documentation Driven',
    description: 'API docs are generated from source JSDoc, keeping examples and implementation in sync',
